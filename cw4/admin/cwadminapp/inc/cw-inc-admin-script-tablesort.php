...
==========================================================
File: cw-inc-admin-script-tablesort.php
...
// CW TABLESORTER: add links to <th> text with jQuery ?>
...
var CWsortLink = function(th, baseurl) {
	...
	// dynamic sortby
	var currentsortby = '<?php echo $_GET["sortby"]; ?>';
	var currentsortdir = '<?php echo $_GET["sortdir"]; ?>';
	var	linksortdir = 'asc';
	//alert(currentsortdir + ' <?php echo $_GET["sortdir"]; ?>');
