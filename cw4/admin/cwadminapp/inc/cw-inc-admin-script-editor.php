...
==========================================================
File: cw-inc-admin-script-editor.php
...
if (strlen(trim($_ENV["application.cw"]["adminEditorCSS"]))) {
	$RTEContent .= ",styleselect";
}
$RTEContent .= ",justifyleft,justifycenter,justifyright,|,code,preview,fullscreen\",
			...
			";
if (strlen(trim($_ENV["application.cw"]["adminEditorCSS"]))) {
	$RTEContent .= "content_css :  \"../" . $_ENV["application.cw"]["adminEditorCSS"] . "\",";
}
$RTEContent .= "			
