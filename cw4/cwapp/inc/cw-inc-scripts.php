...
==========================================================
File: cw-inc-scripts.php
File Date: 2012-02-01
Description:
Manages javascript functions for Cartweaver application
==========================================================
*/
// form validation functions ?>
<script src="<?php echo $_ENV["request.cw"]["assetSrcDir"];?>js/jquery.metadata.js" type="text/javascript"></script>
<script src="<?php echo $_ENV["request.cw"]["assetSrcDir"];?>js/jquery.validate.js" type="text/javascript"></script>
<script src="<?php echo $_ENV["request.cw"]["assetSrcDir"];?>js/jquery.calculation.js" type="text/javascript"></script>
...
chdir($myDir);
// fancybox javascript ?>
<script src="<?php echo $_ENV["request.cw"]["assetSrcDir"];?>js/fancybox/jquery.fancybox.pack.js" type="text/javascript"></script>
<?php // fancybox css required for proper function ?>
<link href="<?php echo $_ENV["request.cw"]["assetSrcDir"];?>js/fancybox/jquery.fancybox.css" rel="stylesheet" type="text/css">
<?php // start script ?>
